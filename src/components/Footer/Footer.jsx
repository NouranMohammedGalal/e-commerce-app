...
export default function Footer() {
  return (
    <footer className="bg-gray-100 py-10 mx-auto">
      <div className="mx-auto w-10/12 ">
        <form className="w-full">
          ...
          <div className="flex p-6 items-center md:space-x-6 md:flex-row flex-col">
            <input
              type="email"
            ...
            <button
              type="submit"
              className="bg-active text-white md:text-lg text-sm px-4 py-2 rounded hover:bg-green-600 md:mt-0 mt-2"
            >
              Share App Link
            </button>
          </div>
